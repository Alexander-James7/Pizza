...
// 
// This block asks for the diamater of the user's pizza, and establishes the matierial cost of $0.50 per diameter. 
...
// Created on: 9/30/2022
// 
// These next lines perform the calculations. They multiply the diameter by the matieral cost, add the aditional costs, add the tax and then round.
let Material_cost = diameter * MATS
let wadditional_costs = Material_cost + 1.75
let tax = wadditional_costs * 1.13
let round = tax * 100
let round2 = Math.round(round)
let Final = round2 / 100
// Created by:  Alexander James
// 
// Created on: 9/30/2022
// 
// The final blocks splash the final price, and splash a pizza sprite for fun. It then holds for 2 seconds and then resets the program.
game.splash("Your Final Price is $" + Final)
